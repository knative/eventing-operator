...
# Generated Knative eventing Operator component YAML files
readonly EVENTING_OPERATOR_YAML=${YAML_OUTPUT_DIR}/eventing-operator.yaml
...
echo "Building Knative Eventing Operator"
